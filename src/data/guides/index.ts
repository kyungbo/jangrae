...
- 금융감독원 상조 관련 정보 확인`,
  ...
  {
    slug: "sangjo-cancellation",
    title: "상조 해지 완전 가이드: 절차, 환급금, 주의사항 총정리",
    description:
      "상조 해지를 고민 중이신가요? 해지 절차, 환급금 계산법, 손해 줄이는 방법, 해지 vs 유지 판단 기준을 알려드립니다.",
    publishedAt: "2026-04-13",
    updatedAt: "2026-04-13",
    readingTime: 8,
    tags: ["상조", "상조 해지", "해약", "환급금"],
    sections: [
      {
        heading: "상조 해지, 언제 고려해야 할까?",
        content: `상조를 해지하려는 이유는 다양합니다. 다음에 해당한다면 해지를 진지하게 검토해 보세요.
...
- 차이가 있으면 소비자상담센터(1372)에 상담하세요.`,
      ...
      {
        heading: "환급금, 얼마를 돌려받을 수 있나?",
        content: `**법정 최소 환급률 (할부거래법 기준)**
...
- 금융감독원 상조 관련: 1332`,
      ...
      {
        heading: "상조 대신 선택할 수 있는 대안",
        content: `상조를 해지한 후에도 장례를 잘 준비할 수 있습니다.
